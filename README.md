...
|------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Trabaja en equipo para proporcionar liderazgo en forma conjunta                          | **Victor Herrera Castillo:**<br>**TB1:** Coordiné tareas asignadas relacionadas con entrevistas y estrategias del sistema, fomentando la colaboración en equipo.<br>**TP1:** Lideré la elaboración de criterios de aceptación en las User Stories y participé activamente en la definición de prioridades, asegurando la comprensión del equipo.<br>**Anderson Walter Macedo Calsina:**<br>**TB1:** Aporté al análisis de competidores y coordinación de entrevistas, manteniendo reuniones constantes para decisiones conjuntas.<br>**TP1:** Guié la creación del C4 model junto al equipo, facilitando la integración arquitectónica y la toma de decisiones compartida.<br>**Carlos Daniel Pingus Rodriguez:**<br>**TB1:** Lideré la delimitación del alcance técnico en los bounded context y propuse soluciones acordes al equipo.<br>**TP1:** Contribuí en la mejora del Impact Mapping y revisión de escenarios To-Be, promoviendo sesiones de validación colaborativa.<br>**Fernando Daniel Quispe Condori:**<br>**TB1:** Organicé sesiones de avance para asegurar consistencia en los entregables del equipo.<br>**TP1:** Dirigí la elaboración del User Journey Map, promoviendo la participación activa de todos para representar la experiencia del usuario.<br>**Christopher Sebastian More Rondon:**<br>**TB1:** Encargado de Needfinding y estructura del informe, mantuve revisiones constantes.<br>**TP1:** Lideré la actualización de la User Task Matrix, coordinando con el equipo el refinamiento de necesidades clave.<br>**Jair Velasquez Pizarro:**<br>**TB1:** Encargado de los requerimientos funcionales iniciales.<br>**TP1:** Propuse mejoras técnicas en los artefactos de diseño y participé en sesiones de feedback técnico con liderazgo compartido.<br>**Jeferson Smith Cabrera Camizan:**<br>**TB1:** Lideré el Event Storming y la estructuración de contextos delimitados.<br>**TP1:** Guié la priorización del backlog con base en las User Stories, asignando tareas de forma equitativa. | En las entregas TB1 y TP1, el liderazgo compartido fue una constante en el equipo. Todos los miembros asumieron responsabilidades claves según sus fortalezas, lo que permitió un desarrollo fluido del proyecto. Desde la elaboración del Needfinding, entrevistas y estrategias técnicas, hasta la estructuración de arquitecturas como el modelo C4 y la planificación del backlog, el equipo trabajó de forma cohesionada. El liderazgo conjunto no solo impulsó la calidad del trabajo, sino que fortaleció la autonomía, el compromiso y la capacidad de decisión de todos los integrantes. Las decisiones se tomaron en espacios de diálogo, promoviendo un entorno donde cada voz fue valorada. |
| Crea un entorno colaborativo e inclusivo, establece metas, planifica tareas y cumple objetivos. | **Victor Herrera Castillo:**<br>**TB1:** Contribuí en la definición de funcionalidades según las necesidades del usuario, trabajando con el equipo en un entorno de escucha activa.<br>**TP1:** Participé en la organización del backlog, estableciendo metas claras con tareas distribuidas equitativamente.<br>**Anderson Walter Macedo Calsina:**<br>**TB1:** Coordiné análisis de soluciones tecnológicas existentes para identificar ventajas competitivas.<br>**TP1:** Facilitador de sesiones de priorización colaborativa, ayudando a alinear los objetivos técnicos con las metas del sprint.<br>**Carlos Daniel Pingus Rodriguez:**<br>**TB1:** Delimitación colaborativa de bounded contexts.<br>**TP1:** Colaboré en la planificación del escenario To-Be con enfoque participativo y organizativo.<br>**Fernando Daniel Quispe Condori:**<br>**TB1:** Planifiqué y ejecuté mis tareas con apoyo mutuo del equipo.<br>**TP1:** Coordiné sesiones de ideación para construir el User Journey Map e identificar mejoras con base en datos compartidos.<br>**Christopher Sebastian More Rondon:**<br>**TB1:** Identificación de funcionalidades junto al equipo.<br>**TP1:** Documenté procesos clave en la Task Matrix y apoyé la definición del flujo de experiencia de usuario con aportes de todos.<br>**Jair Velasquez Pizarro:**<br>**TB1:** Coordinación para delimitar funcionalidades requeridas.<br>**TP1:** Apoyé en la construcción de artefactos de diseño técnico, colaborando con diferentes roles del equipo.<br>**Jeferson Smith Cabrera Camizan:**<br>**TB1:** Propuse el flujo colaborativo para levantar eventos, comandos y contextos del sistema.<br>**TP1:** Planifiqué tareas del Product Backlog en conjunto, implementando métodos ágiles para una ejecución ordenada. | Durante TB1 y TP1, el equipo demostró un alto grado de organización y cohesión. Se establecieron metas claras desde el inicio y se utilizaron herramientas como reuniones periódicas, documentos compartidos y Jira para facilitar la planificación y el seguimiento de tareas. Cada integrante contribuyó activamente en la generación de ideas, la toma de decisiones y la ejecución de actividades. La inclusión fue una constante, permitiendo que todos los miembros participaran sin restricciones, y valorando el aporte individual en función del objetivo común. Esto permitió cumplir exitosamente los objetivos planteados en cada fase del proyecto. |
...
E2-US12                                                                                                                                                                                                                                                                                                                | Gestión y revisión de alertas para cooperativas          | <p>**Como** cooperativa que gestiona varios agricultores </p><p>**Quiero** recibir y revisar alertas generadas en cualquiera de los cultivos bajo mi gestión </p><p>**Para** coordinar con los agricultores las acciones correctivas necesarias y prevenir daños mayores </p>                                        | <p>**Escenario 1: Recepción de alertas múltiples** </p><p>**Dado que** la cooperativa tiene varios campos asociados </p><p>**Cuando** uno o más sensores detectan condiciones anómalas en cualquiera de los campos </p><p>**Entonces** el sistema genera alertas visibles en un panel centralizado con detalle de ubicación, tipo de alerta y prioridad. </p><p></p><p>**Escenario 2: Confirmación y seguimiento de alertas** </p><p>**Dado que** que la cooperativa revisa una alerta recibida </p><p>**Cuando** marca la alerta como atendida o en seguimiento </p><p>**Entonces** el sistema registra el estado para seguimiento y reporte </p><p></p><p></p><p></p><p></p>                                                                                               |    2    |
 ...
 | E6-TS05                                                                                                                                                                                                                                                                                                                | Servicio de integracion con dispositivos IoT                 | <p>**Como** developer </p><p>**Quiero** implementar un servicio que reciba datos desde dispositivos IoT vía MQTT y los procese </p><p>**Para** integrarlos con el sistema general y persistir su información </p>                   | <p>**Escenario 1: Recepción de datos MQTT exitos**a </p><p>**Dado que** un dispositivo IoT publica datos en un topic MQTT configurado </p><p>**Cuando** el servicio MQTT los recibe </p><p>**Entonces** procesa y guarda los datos correctamente en la base de datos </p><p></p><p>**Escenario 2: Error en el procesamiento de datos del dispositivo** </p><p>**Dado que** los datos recibidos por MQTT tienen formato inválido </p><p>**Cuando** el servicio intenta procesarlos </p><p>**Entonces** registra el error y envía una notificación al sistema de monitoreo </p><p></p>                                                                |    5    |                                                                           | <p>**Epic 7: Gestión de Suscripciones y Pagos**</p><p>**Como** cooperativa o agricultor </p><p>**Quiero** acceder a planes de suscripción y gestionar pagos </p><p>**Para** obtener o cancelar funcionalidades premium según mis necesidades </p> | | | | |
...
<img src="./Assets/Style-Guidelines/colores-new.png">
